...
export default function PasswordReset() {
  return (
    <div className='pt-14 pb-20'>
     <div>
            <h1 className='text-primary text-center mb-8 text-7xl font-semibold	'>Зміна пароля</h1>
        </div>
        ...
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
            ...
            <div>
            <button type="submit" class="bg-dimLate hover:bg-dimMoca transition-colors ease-in-out duration-300 py-5 px-9 text-secondary text-center">Ресет Пассворд</button>
            </div>
