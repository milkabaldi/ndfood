...
export const LogIn = () => {
    ...
    <div className='pt-14 pb-20'>
        ...
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
            ...
            <button type="submit" class="w-full text-primary bg-brown hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600">Sing In</button>
        </form>
    </div>
  )
}
