    ...
    <section className='p-20 fixed top-0 right-0 bg-secondary h-full hidden'>
      <div className='flex justify-between mb-10'>
        ...
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ваша пошта</label>
            ...
            <div>
            <button type="submit" class="bg-dimLate hover:bg-dimMoca transition-colors ease-in-out duration-300 py-5 px-9 text-secondary text-center">Реєстрація Testova</button>
            </div>     
        </form>
    </section>
  )
